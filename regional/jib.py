...
ocm_dict = {-2.0: "ulow", -1.0: "low", 0.0: "mid", 1.0: "high", 2.0: "m10", 3.0: "m15"}
tct_dict = {-2.0: "ulow", -1.0: "low", 0.0: "mid", 1.0: "high"}
        ...
        with open(script_combined, "w") as f_combined:
            ...
            for start in range(simulation_start_year, simulation_end_year, restart_step):
                ...
                with open(script, "w") as f:
                    ...
                    ocean_files = {
                        "ulow": "$input_dir/data_sets/ocean_forcing/ocean_forcing_200myr_71n_10myr_80n.nc",
