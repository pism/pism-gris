...
def prepare_pr(dry=False):
    ...
    if dry == False:
        ...
        opt = [
            c.Atted(mode="o", att_name="units", var_name="precipitation", value="kg m-2 yr-1"),
...
def prepare_tas(dry=False):
    ...
    if dry == False:
        ...
        opt = [
            c.Atted(mode="d", att_name="standard_name", var_name="air_temp_mean_annual"),
...
def prepare_smb(dry=False):
    ...
    if dry == False:
        ...
        cdo.timmean(
            input="-mulc," + str(ice_density / 1000) + " -yearsum " + smb_merged_file_daily_mean,
        ...
        opt = [
            c.Atted(mode="o", att_name="units", var_name="climatic_mass_balance", value="kg m-2 yr-1"),
            c.Atted(
                mode="o",
