...
for id in {100..185}; do qsub /nobackupp8/aaschwan/pism-gris/stability/2018_08_les_sky/run_scripts/lhs_g1800m_v3a_rcp_85_id_${id}_j.sh; done
...
for id in {200..299}; do qsub /nobackupp8/aaschwan/pism-gris/stability/2018_08_les_san/run_scripts/lhs_g1800m_v3a_rcp_45_id_${id}_j.sh; done
...
./lhs_ensemble.py -e ../latin_hypercube/lhs_samples_gcm.csv --spatial_ts none --o_dir ${odir} --exstep 1 -n ${n} -w 24:00:00 -g ${grid} -s ${s} -q ${q} --step 1000 --duration 1000 ../calibration/2017_06_vc/state/gris_g${grid}m_flux_v3a_no_bath_sia_e_1.25_sia_n_3_ssa_n_3.25_ppq_0.6_tefo_0.02_calving_vonmises_calving_0_100.nc

for id in {000..096}; do qsub /nobackupp8/aaschwan/pism-gris/stability/2018_08_les_bro/run_scripts/lhs_g1800m_v3a_rcp_26_id_${id}_j.sh; done
