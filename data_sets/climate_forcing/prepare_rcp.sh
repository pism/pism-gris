...
for rcp in 26 45 85; do
    ...
    cdo -O -P 4 ensmean ${var}_Amon_GISS-E2-H_rcp${rcp}_${ens}_ym_anom_GRIS_0-5000.nc ${var}_Amon_GISS-E2-R_rcp${rcp}_${ens}_ym_anom_GRIS_0-500000.nc ${var}_Amon_IPSL-CM5A-LR_rcp${rcp}_${ens}_ym_anom_GRIS_0-500000.nc ${var}_Amon_MPI-ESM-LR_rcp${rcp}_${ens}_ym_anom_GRIS_0-5000.nc ${var}_Amon_ENSMEAN_rcp${rcp}_${ens}_ym_anom_GRIS_0-500000.nc
