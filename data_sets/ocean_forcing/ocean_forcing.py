...
parser.add_argument("--bmelt_0", dest="bmelt_0", type=float, help="southern basal melt rate, in m yr-1", default=228)
parser.add_argument("--bmelt_1", dest="bmelt_1", type=float, help="northern basal melt rate, in m yr-1", default=10)
parser.add_argument("--lat_0", dest="lat_0", type=float, help="latitude to apply southern basal melt rate", default=69)
parser.add_argument("--lat_1", dest="lat_1", type=float, help="latitude to apply northern basal melt rate", default=80)
parser.add_argument(
    "-m",
    "--process_mask",
    dest="mask",
    action="store_true",
    help="""
                    Process the mask, no melting on land""",
    default=False,
)
