...
parser.add_argument("--firn_0", dest="firn_0", type=float, help="fir thickness at alt_0, in m", default=0.0)
parser.add_argument("--firn_1", dest="firn_1", type=float, help="firn thickness at alt_1, in m", default=100.0)
parser.add_argument("--alt_0", dest="alt_0", type=float, help="altitude 0", default=1200.0)
parser.add_argument("--alt_1", dest="alt_1", type=float, help="altitude 1", default=3000.0)
