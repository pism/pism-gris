...
parser.add_argument("--tct_0",dest="tct_0", type=float,
                    help="southern thickness calving threshold, in m",default=400)
parser.add_argument("--tct_1",dest="tct_1", type=float,
                    help="northern thickness calving threshold, in m",default=50)
parser.add_argument("--lat_0",dest="lat_0", type=float,
                    help="latitude to apply southern thickness calving threshold",default=74)
parser.add_argument("--lat_1",dest="lat_1", type=float,
                    help="latitude to apply northern thickness calving threshold",default=76)
