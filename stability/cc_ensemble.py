...
for n, combination in enumerate(combinations):
    ...
    for cc in ccs:
        ...
        m_ohc = 0.0
        try:
            run_id, gcm, fice, fsnow, prs, rfr, ocm_v, ocs_v, tct_v, vcm, ppq, sia_e, m_bd, m_tlr, m_firn, m_pdd, m_ohc, m_gcm, m_sb = combination
        ...
        climate_modifier_file = '$input_dir/data_sets/climate_forcing/pism_cc_{cc}K.nc'.format(cc=cc)
