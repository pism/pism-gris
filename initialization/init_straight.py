...
save_times = [-100000, -25000, -20000, -15000, -11700, -1000, -500, -200, -100, -5]
...
thickness_calving_threshold_values = [50, 75]
ppq_values = [0.33]
tefo_values = [0.020]
phi_min_values = [5.0]
phi_max_values = [40.]
topg_min_values = [-700]
topg_max_values = [700]
combinations = list(itertools.product(ocean_melt_power_values, thickness_calving_threshold_values,
