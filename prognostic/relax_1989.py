...
parser.add_argument("--climate", dest="climate", choices=["relax"], help="Climate", default="relax")
parser.add_argument(
    "--climate_file",
    dest="climate_file",
    help="Climate file with temperature and climatic mass balance.",
    default="GR6b_ERAI_1989_2011_4800M_BIL_1989_mday-1.nc",
)
parser.add_argument(
    "--calving",
    dest="calving",
...
parser.add_argument("--duration", dest="dura", type=int, help="Length of simulation in years (integers)", default=25)
parser.add_argument(
    "-f",
    "--o_format",
    dest="oformat",
