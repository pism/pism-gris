...
mpiexec -n 48 $HOME/pism-dev/bin/pismr \
        -i ../data_sets/bed_dem/pism_Greenland_3600m_mcb_jpl_v3a_ctrl.nc \
        -bootstrap \
        -Mz 3 \
        -time_file ../data_sets/hydrology/DMI-HIRHAM5_GL2_ERAI_1980_2014_MRROS_DM_EPSG3413_3600m_0.nc \
        -hydrology routing \
        -hydrology.tillwat_max 0 \
        -stress_balance none \
        -energy none \
        -hydrology.surface_input_file ../data_sets/hydrology/DMI-HIRHAM5_GL2_ERAI_1980_2014_MRROS_DM_EPSG3413_3600m_0.nc \
        -extra_times daily \
        -extra_vars bwat,tillwat,hydrology_fluxes,subglacial_water_input_rate \
        -extra_file $output_dir/ex_g3600m_water_routing_DMI-HIRHAM5_GL2_ERAI_1980_2014_dm.nc \
