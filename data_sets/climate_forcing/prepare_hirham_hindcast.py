...
parser.add_argument("--shape_file", dest="shape_file", help="Path to shape file with basins", default=None)
parser.add_argument(
    "-v",
    "--variable",
    dest="VARIABLE",
...
PR_files = [
    "DMI-HIRHAM5_GL2_ERAI_1980_1990_PR_DM.nc.gz",
    "DMI-HIRHAM5_GL2_ERAI_1991_2000_PR_DM.nc.gz",
