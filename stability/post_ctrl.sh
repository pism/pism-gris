...
for rcp in 85; do
    for run in CAP6 CAP6NTRL CAP6NISO NTRL NISO; do
        ncks -O ts_gris_g${grid}m_v3a_rcp_${rcp}_id_${run}_0_1000.nc ../scalar_clean/ts_gris_g${grid}m_v3a_rcp_${rcp}_id_${run}_0_1000.nc
        adjust_timeline.py -i start -p yearly -a 2008-1-1 -u seconds -d 2008-1-1 ../scalar_clean/ts_gris_g${grid}m_v3a_rcp_${rcp}_id_${run}_0_1000.nc
    done
done
...
for rcp in 26 45 85; do
    for run in CTRL NTRL; do
        ...
        cdo -L -O -f nc4 -z zip_3 fldsum -aexpr,"surface_runoff_rate_corrected=surface_runoff_rate*sftgif,surface_accumulation_rate_corrected=surface_accumulation_rate*sftgif,dMdt_corrected=dMdt*sftgif;tendency_of_ice_mass_due_to_conservation_error_corrected=tendency_of_ice_mass_due_to_conservation_error*sftgif;tendency_of_ice_mass_due_to_basal_mass_flux_corrected=tendency_of_ice_mass_due_to_basal_mass_flux*sftgif;tendency_of_ice_mass_due_to_surface_mass_flux_corrected=tendency_of_ice_mass_due_to_surface_mass_flux*sftgif;tendency_of_ice_mass_due_to_discharge_corrected=tendency_of_ice_mass_due_to_discharge*sftgif;" -setattribute,dMdt@units="Gt year-1" -aexpr,"dMdt=tendency_of_ice_mass-tendency_of_ice_mass_due_to_flow" -selvar,ice_mass,tendency_of_ice_mass,tendency_of_ice_mass_due_to_flow,tendency_of_ice_mass_due_to_conservation_error,tendency_of_ice_mass_due_to_basal_mass_flux,tendency_of_ice_mass_due_to_surface_mass_flux,tendency_of_ice_mass_due_to_discharge,surface_runoff_rate,surface_accumulation_rate,sftgif $odir/spatial/ex_gris_g${grid}m_v3a_rcp_${rcp}_id_${run}_0_1000.nc $odir/fldsum/ts_gris_g${grid}m_v3a_rcp_${rcp}_id_${run}_0_1000.nc
