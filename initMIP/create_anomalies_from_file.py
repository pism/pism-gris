...
parser.add_argument("--topo_file", dest="topo_file", help="""Topo smb file""")
parser.add_argument("--anomaly_file", dest="anomaly_file", help="""Anomaly smb file""")
parser.add_argument("--background_file", dest="background_file", help="""Background smb file""")
