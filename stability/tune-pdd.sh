...
odir=2017_03_tune_pdd_cycle_sd
./warming_restart.py -s debug -n 4 -g 4500 --end_year 2 --step 2 --exstep 1 --test_climate_models --params fsnow,fice,lapse --o_dir $odir --o_format netcdf3 g4500m_tune_pdd.nc
