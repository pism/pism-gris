...
parser.add_argument(
    "-n", "--n_procs", dest="n", type=int, help="""number of cores/processors. default=28.""", default=28
)
parser.add_argument("-w", "--wall_time", dest="walltime", help="""walltime. default: 8:00:00.""", default="8:00:00")
parser.add_argument(
...
parser.add_argument("--exstep", dest="exstep", type=int, help="Writing interval for spatial time series", default=10)
parser.add_argument(
    "-f",
    "--o_format",
    dest="oformat",
...
for n, combination in enumerate(combinations):
    ...
    with open(script, "w") as f:
        ...
        climate_params_dict = generate_climate(
            climate, climatic_mass_balance="-2.5,3,200,1500,2000", ice_surface_temp="-5,-20,0,2000"
        )
        ocean_params_dict = generate_ocean(ocean)
        hydro_params_dict = generate_hydrology(hydrology)
        calving_params_dict = generate_calving(calving, ocean_kill_file=pism_dataname, thickness_calving_threshold=200)
