...
parser.add_argument(
    "-n", "--n_procs", dest="n", type=int, help="""number of cores/processors. default=192.""", default=192
)
parser.add_argument("-w", "--wall_time", dest="walltime", help="""walltime. default: 96:00:00.""", default="96:00:00")
parser.add_argument(
...
parser.add_argument(
    "-g", "--grid", dest="grid", type=int, choices=grid_choices, help="horizontal grid resolution", default=1200
)
parser.add_argument(
...
parser.add_argument("--duration", dest="dura", type=int, help="Length of simulation in years (integer)", default=50)
parser.add_argument(
...
parser.add_argument(
    ...
    action="store_true",
    help="Regrid ice thickness from input file.",
    default=False,
)
parser.add_argument(
    "-s", "--system", dest="system", choices=list_systems(), help="computer system to use.", default="chinook"
)
parser.add_argument(
    "--stress_balance",
    dest="stress_balance",
...
for n, combination in enumerate(combinations):
    ...
    if bed_type is None:
        experiment = "_".join(
            [climate, vversion, "_".join(["_".join([k, str(v)]) for k, v in list(name_options.items())])]
        )
    else:
        experiment = "_".join(
